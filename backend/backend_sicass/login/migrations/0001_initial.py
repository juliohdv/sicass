# Generated by Django 3.2.4 on 2021-11-20 14:51
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Proyecto',
            fields=[
                ('codigo_proyecto', models.BigAutoField(primary_key=True, serialize=False, unique=True)),
                ('observaciones', models.CharField(max_length=500)),
                ('estado_proyecto', models.TextField(default='En Proceso', max_length=50)),
            ],
        ),
        migrations.CreateModel(
            name='ServicioSocial',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='login.solicitudserviciosocial'),
        ),
        migrations.AddField(
