...
export default class InformeTiempo extends Component {
  constructor(props) {
    super(props);
    this.state = {
      proyectos: [],
              ...
              >
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      Informe en donde se puede visualizar el tiempo de finalización de los proyectos de servicio social.
                    </td>
                    <td>
                      <ReactToPrint
